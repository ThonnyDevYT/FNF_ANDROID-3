...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if(ClientPrefs.data.timeBarType == 'Song Name') timeTxt.text = SONG.song + ' | ' + Difficulty.getString().toUpperCase();
	...
	public function triggerEvent(eventName:String, value1:String, value2:String, strumTime:Float) {
		...
		switch(eventName) {
			...
			case 'Set Alpha CamHUD':
				if(flValue1 == null) flValue1 = 1;
				if(flValue2 == null) flValue2 = 2;

				FlxTween.tween(camHUD, {alpha: flValue1}, flValue2, {ease: FlxEase.circOut});
