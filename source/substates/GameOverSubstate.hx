...
class GameOverSubstate extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float, camX:Float, camY:Float)
	{
		...
		/*var tip:FlxText = new FlxText(boyfriend.x, boyfriend.y, 'Has Muerto... [' + PlayState.deathcause +']', 120);
		tip.setFormat("", 70, FlxColor.WHITE, CENTER, OUTLINE, FlxColor.BLACK, true);
		tip.borderSize = 2;
		tip.screenCenter(X);
